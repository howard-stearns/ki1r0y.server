"use strict";
/*jslint browser: true, devel: true, vars: true, forin: true, plusplus: true */
/// Common utilities used by Kilroy.
/// Copyright (c) 2013 Beyond My Wall. All rights reserved until we get a clue.

var ActiveXObject;
function noop() { }  // Just one place for jslint to complain about.
...
function makeReorderable(draggables, optionalDropCallback, optionalDragCallback) {
	...
	doDraggables(function (elt) { // Side effect each draggable with correct handlers.
		...
		handle('dragenter', function (/*e*/) {   // this/e.target is the current hover target.
		...
		handle('dragleave', function (/*e*/) { removeAffordanceClasses(this); });
		handle('dragend', function (/*e*/) { doDraggables(removeAffordanceClasses); });
